...
mod tests {
    ...
    fn test_mnemonic_generation_has_scalar_prefix() {
        ...
        assert!(phrase.starts_with(SCALAR_PREFIX_WORD), "Kata pertama harus 'scalar'");
    }
    ...
    fn test_bitcoin_mnemonic_rejection() {
        ...
        assert!(matches!(result, Err(KeyError::BitcoinMnemonicDetected)), "Harus menolak mnemonic BTC");
    }
}
