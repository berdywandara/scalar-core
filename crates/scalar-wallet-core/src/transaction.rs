...
impl TransactionBuilder {
    ...
    pub fn build_transfer(&self, target_pubkey: &[u8], amount: u64, fee: u64) -> Result<ScalarMessage, &'static str> {
        ...
        let signature = sign_message(&payload, &self.keypair.secret).unwrap_or_else(|_| vec![0u8; 64]);
